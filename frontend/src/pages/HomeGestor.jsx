      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { icon: "📊", title: "Dashboard da equipe", sub: "Ver métricas agregadas de saúde mental", path: "/dashboard" },
              { icon: "🚨", title: "Alertas",              sub: "Funcionários que precisam de atenção",   path: "/alertas" },
            ].map((card, i) => (

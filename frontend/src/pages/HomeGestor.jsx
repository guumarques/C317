...
export default function HomeGestor() {
  ...
  const CARDS = [
    { icon: <BarChart2 size={22} className="text-green-700" />, title: "Dashboard da equipe", sub: "Ver métricas agregadas de saúde mental", path: "/dashboard" },
    { icon: <Bell size={22} className="text-green-700" />,      title: "Alertas",             sub: "Funcionários que precisam de atenção",  path: "/alertas" },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="bg-green-700 h-12 flex items-center px-5 gap-3 flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] bg-white/15 text-white px-2 py-0.5 rounded-full">Gestor</span>
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <p className="text-xs text-gray-400 mb-6">Painel do gestor</p>
